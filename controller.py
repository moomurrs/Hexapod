...
class Controller:
    ...
    def __init__(self):
        ...
        Controller.i2c.readfrom(0x55, 12)
    ...
    def update(self):
        ...
        # reading 12 bytes before controller isn't ready presents the value below
        null_stream = b'\x01\xfc\x03q\x01\xfc\x01\xfc\x00\x00\xeb\x00'
        #print(hex_stream)
        if hex_stream == null_stream:
            # controller value is garbage, exit
            #print("bad")
            return False
        #print("good")
        ...
        self.value["buttons"] = (int.from_bytes(hex_stream, "big") >> (8 * 2)) & two_byte_mask
